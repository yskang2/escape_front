...
export const links = [
  {
    title: { Eng: 'GETTING STARTED', Kor: '시작하기' },
    links: [
      {
        name: { Eng: 'Dashboard', Kor: '대시보드' },
        path: 'dashboard',
        icon: <FiShoppingBag />,
      },
      {
        name: { Eng: 'EMR', Kor: 'EMR' },
        path: 'EMR',
        icon: <FiShoppingBag />,
      },
      {
        name: { Eng: 'VR contents', Kor: 'VR contents' },
        path: 'VRcontents',
        icon: <FiShoppingBag />,
      },
      {
        name: { Eng: 'MUVEs', Kor: 'MUVEs' },
        path: 'MUVEs',
        icon: <FiShoppingBag />,
      },
    ],
  ...
  {
    title: { Eng: 'BULLETIN BOARD (SHARED)', Kor: '게시판(공유)' },
    links: [
      {
        name: { Eng: 'Free Board', Kor: '자유 게시판' },
        path: 'board',
        icon: <RiContactsLine />,
      },
      {
        name: { Eng: 'Clinical expert communication bulletin board', Kor: '임상전문가 소통 게시판' },
        path: 'ceboard',
        icon: <RiContactsLine />,
      },
    ],
  ...
  {
    title: { Eng: 'BULLETIN BOARD (PERSONAL)', Kor: '게시판(개인)' },
    links: [
      {
        name: { Eng: 'group1', Kor: 'group1' },
        path: 'cnpractice',
        icon: <RiContactsLine />,
      },
      {
        name: { Eng: 'group2', Kor: 'group2' },
        path: 'anpractice',
        icon: <RiContactsLine />,
      },
    ],
  ...
  {
    title: { Eng: 'RECORD SHEET', Kor: '기록지' },
    links: [
      {
        name: { Eng: 'Record Sheet', Kor: '기록지' },
        path: 'record',
        icon: <IoMdContacts />,
      },
    ],
